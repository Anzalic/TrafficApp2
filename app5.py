...
# Automatically get the road type for the selected road
selected_road_type = get_road_type(selected_road_name)
road_type = col3.text_input("Road Type", selected_road_type, disabled=True)  # Display as a text input, but not editable
